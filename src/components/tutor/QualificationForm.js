    ...
    <section className="container mt-5">
      ...
      <form onSubmit={handleSubmit} className="form">
        <div className="row mb-3">
          <div className="col">
            <label htmlFor="student-level" className="form-label">Highest Education Level</label>
            <select
              id="student-level"
          ...
          <div className="col">
            <label htmlFor="grade" className="form-label">Tutor Category</label>
            <select
              id="grade"
              className="form-select"
              value={tutorCategory}
        ...
        <div className="container mt-5">
          ...
          <p>
            Please add AT LEAST TWO of your recent academic studies (e.g. Diploma + University OR A-level + University).
            For undergraduates, please also include your degree details and expected graduation date.
            To obtain the best match, it would be best to input your entire academic journey (i.e. Primary {'>'} Secondary {'>'} JC/Poly {'>'} University).
          </p>
          {educationDetails.map((education, index) => (
            <div key={index} className="mt-4 border rounded p-3">
              <div className="row">
                <div className="col-6">
                  <div className="mb-3">
                    <label htmlFor={`institution-${index}`} className="form-label">Name of Educational Institution</label>
                    <input
                      type="text"
                  ...
                  <div className="mb-3">
                    <label htmlFor={`course-${index}`} className="form-label">Course of Study</label>
                    <input
                      type="text"
                      className="form-control"
                      id={`course-${index}`}
                ...
                <div className="col-6">
                  <div className="mb-3">
                    <label htmlFor={`graduationDate-${index}`} className="form-label">Expected Graduation Date</label>
                    <input
                      type="date"
                      className="form-control"
                  ...
                  <div className="mb-3">
                    <label htmlFor={`gpa-${index}`} className="form-label">Grade Point Average</label>
                    <input
                      type="text"
                      className="form-control"
                      id={`gpa-${index}`}
