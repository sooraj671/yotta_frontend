...
const SignupForm = ({ formData, handleChange, nextStep, prevStep }) => {
  ...
  return (
    <section className="container mt-5">
      ...
      <form onSubmit={handleSubmit} className="form" style={{ width: '30%', margin: '0 auto' }}>
        ...
        <div className="mb-3">
          ...
          <input 
            ...
            name="email" // Add name attribute for handleChange to identify
            placeholder="" 
        ...
        <div className="mb-3">
          ...
          <input 
            ...
            id="username" 
            className="form-control" 
            name="username" // Add name attribute for handleChange to identify
            placeholder="" 
        ...
        <div className="form-check mb-3">
          <input 
            ...
            name="termsAccepted" // Add name attribute for handleChange to identify
            type="checkbox" 
            id="acceptTerms" 
        ...
        <button type="submit" className="btn btn-primary" style={{width:'30%',marginTop: '40%' }}>Next</button>
      </form>
    </section>
  );
};
